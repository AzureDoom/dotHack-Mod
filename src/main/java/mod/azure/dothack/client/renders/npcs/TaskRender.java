...
public class TaskRender extends GeoEntityRenderer<NPCEntity> {

	private static ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID, "textures/entity/task.png");

	public TaskRender(EntityRendererProvider.Context renderManagerIn) {
