...
public class OborozukiyoRender extends GeoEntityRenderer<NPCEntity> {

	private static ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID, "textures/entity/oborozukiyo.png");

	public OborozukiyoRender(EntityRendererProvider.Context renderManagerIn) {
