...
public class HelbaRender extends GeoEntityRenderer<NPCEntity> {

	private static ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID, "textures/entity/helba.png");

	public HelbaRender(EntityRendererProvider.Context renderManagerIn) {
