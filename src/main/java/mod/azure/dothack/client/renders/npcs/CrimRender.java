...
public class CrimRender extends GeoEntityRenderer<NPCEntity> {
	...
	private static ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID, "textures/entity/crim.png");

	public CrimRender(EntityRendererProvider.Context renderManagerIn) {
