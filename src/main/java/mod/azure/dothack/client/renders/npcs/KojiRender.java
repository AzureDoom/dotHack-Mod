...
public class KojiRender extends GeoEntityRenderer<NPCEntity> {

	private static ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID, "textures/entity/koji.png");

	public KojiRender(EntityRendererProvider.Context renderManagerIn) {
