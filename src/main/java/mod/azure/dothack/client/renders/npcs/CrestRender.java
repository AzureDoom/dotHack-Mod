...
public class CrestRender extends GeoEntityRenderer<NPCEntity> {

	private static ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID, "textures/entity/crest.png");

	public CrestRender(EntityRendererProvider.Context renderManagerIn) {
