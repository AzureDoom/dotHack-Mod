...
public class AuraRender extends GeoEntityRenderer<NPCEntity> {

	private static ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID, "textures/entity/aura.png");

	public AuraRender(EntityRendererProvider.Context renderManagerIn) {
