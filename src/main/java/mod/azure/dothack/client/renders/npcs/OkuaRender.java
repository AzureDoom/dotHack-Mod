...
public class OkuaRender extends GeoEntityRenderer<NPCEntity> {

	private static ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID, "textures/entity/ouka.png");

	public OkuaRender(EntityRendererProvider.Context renderManagerIn) {
