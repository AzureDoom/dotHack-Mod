...
public class HaseoXthRender extends GeoEntityRenderer<NPCEntity> {

	private static ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID, "textures/entity/haseoxth.png");

	public HaseoXthRender(EntityRendererProvider.Context renderManagerIn) {
