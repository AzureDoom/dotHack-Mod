...
public class PiRender extends GeoEntityRenderer<NPCEntity> {

	private static ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID, "textures/entity/pi.png");

	public PiRender(EntityRendererProvider.Context renderManagerIn) {
