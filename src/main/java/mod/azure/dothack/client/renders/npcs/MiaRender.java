...
public class MiaRender extends GeoEntityRenderer<NPCEntity> {

	private static ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID, "textures/entity/mia.png");

	public MiaRender(EntityRendererProvider.Context renderManagerIn) {
