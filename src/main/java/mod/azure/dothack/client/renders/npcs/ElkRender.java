...
public class ElkRender extends GeoEntityRenderer<NPCEntity> {

	private static ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID, "textures/entity/elk.png");

	public ElkRender(EntityRendererProvider.Context renderManagerIn) {
