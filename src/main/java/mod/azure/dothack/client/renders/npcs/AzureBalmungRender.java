...
public class AzureBalmungRender extends GeoEntityRenderer<NPCEntity> {

	private static ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID, "textures/entity/azurebalmung.png");

	public AzureBalmungRender(EntityRendererProvider.Context renderManagerIn) {
