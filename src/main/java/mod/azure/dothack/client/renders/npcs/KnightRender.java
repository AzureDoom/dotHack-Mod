...
public class KnightRender extends GeoEntityRenderer<NPCEntity> {

	private static ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID, "textures/entity/knight.png");

	public KnightRender(EntityRendererProvider.Context renderManagerIn) {
