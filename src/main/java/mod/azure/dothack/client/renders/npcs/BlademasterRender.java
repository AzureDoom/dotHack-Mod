...
public class BlademasterRender extends GeoEntityRenderer<NPCEntity> {

	private static ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID, "textures/entity/blademaster.png");

	public BlademasterRender(EntityRendererProvider.Context renderManagerIn) {
