...
public class AtoliRender extends GeoEntityRenderer<NPCEntity> {

	private static ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID, "textures/entity/atoli.png");

	public AtoliRender(EntityRendererProvider.Context renderManagerIn) {
