...
public class ZelkovaRender extends GeoEntityRenderer<NPCEntity> {

	private static ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID, "textures/entity/zelkova.png");

	public ZelkovaRender(EntityRendererProvider.Context renderManagerIn) {
