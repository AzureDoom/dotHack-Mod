...
public class MicinoRender extends GeoEntityRenderer<NPCEntity> {

	private static ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID, "textures/entity/micino.png");

	public MicinoRender(EntityRendererProvider.Context renderManagerIn) {
