...
public class SubaruRender extends GeoEntityRenderer<NPCEntity> {

	private static ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID, "textures/entity/subaru.png");

	public SubaruRender(EntityRendererProvider.Context renderManagerIn) {
