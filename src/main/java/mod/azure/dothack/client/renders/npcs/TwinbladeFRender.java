...
public class TwinbladeFRender extends GeoEntityRenderer<NPCEntity> {

	private static ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID, "textures/entity/twinbladef.png");

	public TwinbladeFRender(EntityRendererProvider.Context renderManagerIn) {
