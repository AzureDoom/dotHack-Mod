...
public class BearRender extends GeoEntityRenderer<NPCEntity> {

	private static ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID, "textures/entity/bear.png");

	public BearRender(EntityRendererProvider.Context renderManagerIn) {
