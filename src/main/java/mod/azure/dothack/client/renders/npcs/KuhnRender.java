...
public class KuhnRender extends GeoEntityRenderer<NPCEntity> {
	...
	private static ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID, "textures/entity/kuhn.png");

	public KuhnRender(EntityRendererProvider.Context renderManagerIn) {
