...
public class TabbyRender extends GeoEntityRenderer<NPCEntity> {

	private static ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID, "textures/entity/tabby.png");

	public TabbyRender(EntityRendererProvider.Context renderManagerIn) {
