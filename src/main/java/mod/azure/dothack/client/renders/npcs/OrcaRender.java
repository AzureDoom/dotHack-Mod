...
public class OrcaRender extends GeoEntityRenderer<NPCEntity> {

	private static ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID, "textures/entity/orca.png");

	public OrcaRender(EntityRendererProvider.Context renderManagerIn) {
