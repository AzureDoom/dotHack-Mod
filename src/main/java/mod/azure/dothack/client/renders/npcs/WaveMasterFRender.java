...
public class WaveMasterFRender extends GeoEntityRenderer<NPCEntity> {

	private static ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID, "textures/entity/wavemasterf.png");

	public WaveMasterFRender(EntityRendererProvider.Context renderManagerIn) {
