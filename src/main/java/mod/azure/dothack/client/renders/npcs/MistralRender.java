...
public class MistralRender extends GeoEntityRenderer<NPCEntity> {

	private static ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID, "textures/entity/mistral.png");

	public MistralRender(EntityRendererProvider.Context renderManagerIn) {
