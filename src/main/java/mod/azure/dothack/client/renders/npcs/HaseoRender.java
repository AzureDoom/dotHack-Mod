...
public class HaseoRender extends GeoEntityRenderer<NPCEntity> {
	...
	private static ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID, "textures/entity/haseo.png");

	public HaseoRender(EntityRendererProvider.Context renderManagerIn) {
