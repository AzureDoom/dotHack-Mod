...
public class AzureOrcaRender extends GeoEntityRenderer<NPCEntity> {

	private static ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID, "textures/entity/azureorca.png");

	public AzureOrcaRender(EntityRendererProvider.Context renderManagerIn) {
