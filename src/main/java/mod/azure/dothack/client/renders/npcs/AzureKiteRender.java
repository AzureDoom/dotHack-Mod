...
public class AzureKiteRender extends GeoEntityRenderer<NPCEntity> {

	private static ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID, "textures/entity/azurekite.png");

	public AzureKiteRender(EntityRendererProvider.Context renderManagerIn) {
