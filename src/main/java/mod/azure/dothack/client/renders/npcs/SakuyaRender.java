...
public class SakuyaRender extends GeoEntityRenderer<NPCEntity> {

	private static ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID, "textures/entity/sakuya.png");

	public SakuyaRender(EntityRendererProvider.Context renderManagerIn) {
