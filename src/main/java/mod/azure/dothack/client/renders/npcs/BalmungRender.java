...
public class BalmungRender extends GeoEntityRenderer<NPCEntity> {

	private static ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID, "textures/entity/balmung.png");

	public BalmungRender(EntityRendererProvider.Context renderManagerIn) {
