...
public class BlackRoseRender extends GeoEntityRenderer<NPCEntity> {

	private static ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID, "textures/entity/blackrose.png");

	public BlackRoseRender(EntityRendererProvider.Context renderManagerIn) {
