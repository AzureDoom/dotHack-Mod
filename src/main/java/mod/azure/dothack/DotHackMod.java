...
public class DotHackMod implements ModInitializer {
	...
	public static final ResourceKey<CreativeModeTab> NPC_TAB = ResourceKey.create(Registries.CREATIVE_MODE_TAB, DotHackMod.modResource("entities"));
	public static final ResourceKey<CreativeModeTab> ITEM_TAB = ResourceKey.create(Registries.CREATIVE_MODE_TAB, DotHackMod.modResource("items"));

	@Override
	public void onInitialize() {
		MOBS = new DotHackMobs();
		ITEMS = new DotHackItems();
		Registry.register(BuiltInRegistries.CREATIVE_MODE_TAB, NPC_TAB, FabricItemGroup.builder().icon(() -> new ItemStack(DotHackItems.AZUREKITE_SPAWN_EGG)) // icon
				.title(Component.translatable("itemGroup.dothack.entities")) // title
		...
		Registry.register(BuiltInRegistries.CREATIVE_MODE_TAB, ITEM_TAB, FabricItemGroup.builder().icon(() -> new ItemStack(DotHackItems.ULTIMATESTEEL)) // icon
				.title(Component.translatable("itemGroup.dothack.items")) // title
				.displayItems((context, entries) -> {
