...
public class SpinRibsItem extends BaseSwordItem {

	public SpinRibsItem(Tier tier, int damage, float speed) {
	...
	public void createRenderer(Consumer<Object> consumer) {
		consumer.accept(new RenderProvider() {
			private SpinRibsRender renderer = null;

			@Override
			public BlockEntityWithoutLevelRenderer getCustomRenderer() {
				if (renderer == null)
					return new SpinRibsRender();
				return renderer;
			}
		});
	}
